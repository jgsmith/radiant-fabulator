module Fabulator
  class Assertion
    ...
    def initialize(xml, def_model = nil)
      ...
      @from  = (xml.attributes.get_attribute_ns(FAB_NS, 'from').value rescue '').split('/')
      @arcs = [ ]
  ...
  protected
    ...
    def execute_arcs(data)
      @arcs.each do |arc_set|
        ...
        Rails.logger.info("Running arc set!\n\n")
        Rails.logger.info(YAML::dump(arc_set))
      ...
      case t[0]
        ...
        when 3:
          ...
          if s =~ /^\?_(.*)/
            ...
            v = $1
            return if data[v].nil?
            self.add_triple(data,bnodes,data[v],[2, t[1], t[2]])
          end
        when 4:
          # object is variable
          if t[2].is_a?(Array)
        ...
        when 5:
          ...
          if s =~ /^\?_(.*)/ # bnode
            ...
            if data[v].nil?
              ...
              self.add_triple(data,bnodes,data[v],[4, t[1], t[2]])
            end
          end
        when 6:
      ...
      if r.is_a?(Array)
        ...
        if r[0] =~ /^\?(.*)/
          ...
          if data[v].nil?
            ...
            return RdfLiteral.build(data[v], r[1])
          end
        else
        ...
        if data[v].nil?
          ...
          return RdfResource.from_uri(data[v])
        end
      else
